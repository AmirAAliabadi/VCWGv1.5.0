...
class UWG(object):
    ...
    def __init__(self, ene_mode, opt_A_PV, opt_A_WT, opt_Infil, opt_Vent, opt_AlbRoof, opt_Glz, opt_SHGC,
                 ...
                 epwFileName, uwgParamFileName=None, epwDir=None, uwgParamDir=None, destinationDir=None, destinationFileName=None):
        ...
        self.l_pcm = None  # Volumetric latent heat of PCM
